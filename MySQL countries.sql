...
# of the country, language and language percentage. Your query should arrange
...
FROM countries
WHERE countries.government_form  = 'Constitutional Monarchy' AND countries.capital >200 AND countries.life_expectancy>70;
